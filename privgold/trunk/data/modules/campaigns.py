...
def LoadTest():
	...
	priv.Init(MakeMission(priv,	
				...
				[],
				AddCredits(13000),
				MovieCutscene('Automated Robotic Message','PoliticianCutscene.ogv',16.0/9.0),
...
def LoadMainCampaign():
	...
	TerrellFinish.Init(priv,
		...
		None,
		None,
		GoToSubnode(0,MovieCutscene('Final Cutscene','OutroCutscene.ogv',16.0/9.0)),
		None,
		[CampaignClickNode().Init(priv,
...
def LoadRFCampaign():
	...
	Theft.Init(rf,
		...
		None,
		GoToSubnode(0,MovieCutscene('Security','RighteousFireCutscene.ogv',16.0/9.0,
